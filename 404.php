	...
	<div id="content">
		...
		<div class="hfeed">
			...
			<div id="post-0" class="<?php hybrid_entry_class(); ?>">
				...
				<h1 class="error-404-title entry-title"><?php _e( 'Not Found', 'sonorous' ); ?></h1>

				<div class="entry-content">

					<p>
					<?php printf( __( 'You tried going to %1$s, and it doesn\'t exist. All is not lost! You can search for what you\'re looking for.', 'sonorous' ), '<code>' . home_url( esc_url( $_SERVER['REQUEST_URI'] ) ) . '</code>' ); ?>
					</p>
